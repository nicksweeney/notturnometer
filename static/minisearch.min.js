/* MiniSearch 7.2.0 — https://github.com/lucaong/minisearch — MIT.
   Vendored deliberately: no build step on this project (hand-rolled CSS, no
   bundler). Replaces `npx --yes pagefind`, which downloaded a platform binary
   at build time — so this is a net reduction in dependency surface. */
/**
